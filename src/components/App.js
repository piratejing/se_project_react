  ...
  const handleDeleteClick = (card) => {
    itemsApi
      ...
      .then(() => {
        ...
        setClothingItems((clothingItems) => clothingItems.filter((item) => item._id !== card._id));
        handleCloseModal();
      })
    ...
    if (isLiked) {
      itemsApi
        ...
        .then(({ data: updatedCard }) => {
          setClothingItems((prevItems) => prevItems.map((item) => (item._id === id ? updatedCard : item)));
        })
    ...
    <BrowserRouter>
      <CurrentUserContext.Provider value={currentUser}>
        ...
        >
          ...
          {activeModal === "image" && (
            <ModalWithImage selectedCard={selectedCard} onClose={handleCloseModal} onDeleteClick={handleDelete} onOutClick={handleOutClick} />
          )}
          {activeModal === "confirm" && (
          ...
          {activeModal === "edit" && <EditModal handleCloseModal={handleCloseModal} handleOutClick={handleOutClick} handleEdit={handleEditSubmit} />}
          {activeModal === "logout" && <LogoutModal handleCloseModal={handleCloseModal} handleOutClick={handleOutClick} logout={handleSignout} />}
          {activeModal === "mobile" && (
            <MobileMenu
              onClose={handleCloseModal}
              onOutClick={handleOutClick}

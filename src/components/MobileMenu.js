...
const MobileMenu = ({ onClose, handleClick, onOutClick, handleSignin, handleRegister, isLoggedIn }) => {
    ...
    <div className="menu" onClick={onOutClick}>
      <div className="menu__container">
        <button type="button" className="menu__button" aria-label="Close">
          <img className="menu__close" alt="Close button" src={closeIcon} onClick={onClose} />
        </button>
        {isLoggedIn ? (
          <>
            <button type="button" className="menu__add" onClick={handleClick} aria-label="Add">
              + Add clothes
            </button>
